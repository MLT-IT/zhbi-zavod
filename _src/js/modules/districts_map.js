let initDistrictsMap;

if (window.is_krasnondar) {
  initDistrictsMap = () => {
    ...
    let balloonContentHTML =
      '<div style="text-align: center;">Часы работы: ежедневно с 8:00 до 21:00<br>Стоимость доставки до 30 км: 990 рублей<br>Телефон склада: <a href="tel:' +
      phoneNumber +
      '">' +
      phoneNumber +
      "</a></div>";
    ...
    $.getJSON(
      "assets/template/json/district_stores_krasnodar.json",
      function (data) {
        data.map((el) => {
