...
foreach ($contexts as $ctx) {
    // TODO: размеры лого лучше получать через код, а не хардкодить. Логика такая: максимальная ширина: 193, максимальная высота: 62. Вычисляем наибольшее значение, а второе подбираем по пропорциям
    switch ($ctx) {
        case 'pilomat':
            $defaultValues = [
