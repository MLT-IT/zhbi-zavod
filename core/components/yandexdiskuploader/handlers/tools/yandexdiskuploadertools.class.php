...
class yandexdiskuploaderTools
{
    ...
    public function runProcessor($action = '', $data = array())
    {
        ...
        $processorsPath = !empty($this->yandexdiskuploader->config['processorsPath']) ? $this->yandexdiskuploader->config['processorsPath'] : MODX_CORE_PATH;

        /* @var modProcessorResponse $response */
        $response = $this->modx->runProcessor($action, $data, array('processors_path' => $processorsPath));

        return $this->yandexdiskuploader->config['prepareResponse'] ? $this->prepareResponse($response) : $response;
    }
    ...
    public function prepareResponse($response)
    {
        ...
        if ($this->yandexdiskuploader->config['jsonResponse'] AND is_array($output)) {
            $output = $this->modx->toJSON($output);
        } elseif (!$this->yandexdiskuploader->config['jsonResponse'] AND !is_array($output)) {
    ...
    {
        if ($pdoTools = $this->yandexdiskuploader->getPdoTools()) {
    ...
    public function success($message = '', $data = array(), $placeholders = array())
    {
        ...
        return $this->yandexdiskuploader->config['jsonResponse'] ? $this->modx->toJSON($response) : $response;
    }
