...
class yandexdiskuploaderObjectUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        if (!$id = (int)$this->getProperty('id')) {
            return $this->modx->lexicon('yandexdiskuploader_err_ns');
        }
...
return 'yandexdiskuploaderObjectUpdateProcessor';