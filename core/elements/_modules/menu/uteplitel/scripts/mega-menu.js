function initMegaMenu() {
    ...
    const submenusCatalog = document.querySelectorAll('.menu-uteplitel__catalog-submenu');
    ...
    const catalogsButton = document.querySelectorAll(".h-menu__btn");
    ...
    */
    function handlersButtonShowMore(submenuContainers) {
        submenuContainers.forEach(submenuContainer => {
            let moreButtonContainer = submenuContainer.querySelector('.menu-uteplitel__submenu-more');
            let moreButton = submenuContainer.querySelector('.menu-uteplitel__submenu-more-button');
            let options = submenuContainer.querySelector('.menu-uteplitel__submenu-options');
