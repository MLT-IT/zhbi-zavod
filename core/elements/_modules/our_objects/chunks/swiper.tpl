<section class="show-room__container sect-showroom-swiper">
{set $imageWidth = 400}
{set $imageHeight = 300}
{set $imagePath = "/assets/images/show-room/{$site_context}"}
{set $showroomImages = '@FILE _modules/our_objects/snippets/getFolderJpgList.php' | snippet : ['file_suffix'=>'gallery', 'folder'=> $imagePath]}          
