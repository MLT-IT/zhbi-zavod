    ...
    <div class="wrapper">
        <div class="footer__left">
            <a class="footer__logo" href="/">
                {if $_modx->resource.context_key in list ['plitaosb', 'web', 'rockwool', 'tn', 'paroc', 'penoplex', 'ursa', 'isover', 'fasady-pro', 'pro-fanera', 'fasad', 'armatura-178']}
                    {*
                    <picture>
       ...
       {if $_modx->getPlaceholder('footer_nav_ids') | length > 1}
        <div class="footer__nav-block">
            ...
            <ul class="footer__nav-list">
                ...
                'tpl' => '@INLINE <li class="footer__nav-item"><a href="{$link}">{$menutitle}</a></li>',
                'where' => '{"template":5}',
                'limit' => '0',
                ]}
            </ul>
