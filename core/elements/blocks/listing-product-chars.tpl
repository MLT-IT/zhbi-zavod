...
<div class="listing__products-item-chars-wrap">
    ...
    <div class="listing__products-item-chars">
        ...
        *}
        ...
        {/if}
        {* Профлист в кровле *}
        {if $src['parent'] in list [86214,43730,81058,81057,81056,81055,81054,81053,81047,43790,43775,43760,43748,43720,43711,43536,41715,41709,41706,41701,41699,41690,41684,41628,37728,26581,81051,81052,26582]}
        ...
        {* Профлист в кровле *}
        {elseif $src['parent'] in list [86214,43730,81058,81057,81056,81055,81054,81053,81047,43790,43775,43760,43748,43720,43711,43536,41715,41709,41706,41701,41699,41690,41684,41628,37728,26581,81051,81052,26582]}
            {set $charsValues = [
                $src['profil'][0],
