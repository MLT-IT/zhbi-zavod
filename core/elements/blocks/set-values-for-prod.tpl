...
{* Если запускать сайт на Windows, то дробная цена должна быть с запятой, иначе ключ рассчитается неправильно и будет невозможно изменить кол-во товара. Если на Linux, то с точкой. *}
