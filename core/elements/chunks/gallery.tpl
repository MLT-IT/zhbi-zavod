...
{if $amountPhotos > 1}
    <div class="product-card__gallery-btns-wrap swiper-buttons"{if (($amountPhotos < 5) && ($_modx->resource.template === 6)) || $_modx->resource.template in list [17, 20]} style="display: none;"{/if}>
