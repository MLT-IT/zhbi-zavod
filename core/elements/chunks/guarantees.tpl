<div class="infoblocks__advantages">
  ...
  <div class="infoblocks__advantage">
    <div class="advantage">
      ...
      <p class="advantage__text">Вы можете заказать доставку по России (ПЭК, СДЭК, Энергия, Возовоз и Деловые линии) или оформить самовывоз с нашего склада в Санкт-Петербурге</p><a class="advantage__link link" href="/dostavka-i-oplata/">Условия доставки и самовывоза</a>
    </div>
  </div>
  <div class="infoblocks__advantage">
    <div class="advantage">
