{set $inCart = $prodValues['itemInCart']}
...
<div class="calcProduct product-info__volume">
  ...
  <input type="hidden" class="js-product__price calcPrice" value="{$prodValues['defaultPrice']?:0}" style="display:none!important">
  <div class="product-info__complex product-calculator">
    <div class="product-calculator__inputs">
      <div>
        ...
        <div class="counter calcInput_length">
    ...
    <div class="calcResult product-calculator__result calculator-result  product-info__price">
      <div class="calcResult_volume calculator-result__summary">
        ...
        <span class="value custom-counter__amount calculator-result__summary-volume">{($inCart * $listSize)?:$listSize | number_format : 2}</span>
