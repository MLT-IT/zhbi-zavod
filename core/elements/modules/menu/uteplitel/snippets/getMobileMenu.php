...
$tpl = $modx->getOption("tpl", $scriptProperties, "@FILE modules/menu/uteplitel/chunks/mobileMenu.tpl");
        ...
        function generateSubmenu($items, $level = 0, $modx) {
            ...
            foreach ($items as $item) {
                if (isset($item['items']) && !empty($item['items'])) {
                    ...
                    $submenuHtml = $pdo->getChunk("@FILE modules/menu/uteplitel/chunks/mobileMenuSubmenu.tpl", array(
