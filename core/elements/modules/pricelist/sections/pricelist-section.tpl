...
{set $remains = "@FILE modules/warehouses/snippets/remains.php" | snippet: ['begin' => 100, 'end' => 300]}
    ...
    <div class="infoblocks__content">
      ...
      {foreach $data.tables as $tbl}
        ...
        {set $data1 = 'msProducts' | snippet : [
          'parents' => $tbl.parents
          'tpl' => '@FILE modules/pricelist/json/item.tpl'
          'depth' => 10
          'limit' => $data.limit
          ...
          <table class="table__table table-delivery">
            ...
            {foreach $data2 as $row}
              <tr class="table__row">
                ...
                {set $remains = "@FILE modules/warehouses/snippets/remains_here.php" | snippet: ['range' => $range, 'id' => $row.id]}
