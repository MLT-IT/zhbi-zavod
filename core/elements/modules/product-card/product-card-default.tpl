            ...
            {/if} *}
                  ...
                  <div class="product-info__volume"><span class="product-info__volume-title">Цена за:</span>
                    ...
                    <div class="product-card__volume">
                      <ul class="product-info__volume-tabs">
                        {if $_modx->runSnippet('@FILE snippets/ultimateParent.php', ['id' => $_modx->resource.id, 'ancestor' => 93445])}
                        {else}
              ...
              {if $_modx->resource.context_key in list ['suhiesmesi']}
                  <div style="margin-top: 20px">
                    {include "file:modules/calculator-opt/chunks/calculator-opt.tpl" product=$_modx->resource}
                  </div>
              {/if}
