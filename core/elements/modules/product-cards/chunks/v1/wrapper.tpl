  ...
  <div class="product-card__content">
    <div class="product-card__top">
      ...
      <a
        ...
        data-tooltip-hover="true"
        {if $idx === 1}data-tooltip-autoload="true"{/if}
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="32" height="35" style="fill: var(--color-red); margin: 0px 1px;">
      ...
      <a class="product-card__image bg-light-gray-2" href="{$id | url}">
            <img src="{$webp ?: '/assets/images/no_image.jpg'}" alt="{$pagetitle}" loading="lazy" onerror="this.onerror=null;this.src='/assets/images/no_image.jpg'"/>
      </a>
