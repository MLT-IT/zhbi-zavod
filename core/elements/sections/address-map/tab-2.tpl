...
<div class="address-map__row">
  <div class="address-map__contacts">
    ...
    <div class="address-map__contacts-item">
      <svg class="contact__icon"><use xlink:href="/assets/template/images/icons.svg#svg-calendar" ></use></svg>
      <div>
    ...
    >
      <svg class="contact__icon"><use xlink:href="/assets/template/images/icons.svg#svg-phone" ></use></svg>
      <div>
    ...
    <a
      class="address-map__contacts-item"
      href="mailto:{$_modx->getPlaceholder('contacts.email')}"
    >
      <svg class="contact__icon"><use xlink:href="/assets/template/images/icons.svg#svg-email" ></use></svg>
      <div>
  ...
  <div class="address-map__map">
    ...
    {else}
      <script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%{$_modx->getPlaceholder('virtual-router')['yandex_map']}&amp;width=100%&amp;height=100%&amp;lang=ru_RU&amp;scroll=true"></script>
    {/if}
  </div>
</div>