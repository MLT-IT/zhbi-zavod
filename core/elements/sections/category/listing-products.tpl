<div class="listing__products">
    ...
    <div class="listing__sort">
        <div id="mse2_sort" class="listing__sort-list"><span>Сортировать: </span>
            <a href="#" data-sort="ms|price" data-dir="" data-default="desc" class="listing__sort-item min{if $.get.sort == ''} active{/if}">по цене</a>
            <a href="#" data-sort="ms_product|menuindex" data-dir="" data-default="desc" class="listing__sort-item min{if $.get.sort == 'ms_product|menuindex:desc'} active{/if}">по популярности</a>
