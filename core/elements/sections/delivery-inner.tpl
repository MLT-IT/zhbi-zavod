<table class="table__table">
  ...
  <tbody>
  <tr class="table__row">
    <td class="table__cell">Машина - 1,5 тн до 14 м3</td>
    <td class="table__cell">4</td>
    <td class="table__cell">от 1 200</td>
  </tr>
  <tr class="table__row">
    <td class="table__cell">Машина - 1,5 тн до 20 м3</td>
    <td class="table__cell">4</td>
    <td class="table__cell">от 1 700</td>
  </tr>
  <tr class="table__row">
    <td class="table__cell">Машина - 3,5 тн до 30 м3</td>
    <td class="table__cell">6</td>
    <td class="table__cell">от 1 900</td>
  </tr>
  <tr class="table__row">
    <td class="table__cell">Машина - 5 тн до 30 м3</td>
    <td class="table__cell">6</td>
    <td class="table__cell">от 2 000</td>
  </tr>
  <tr class="table__row">
    <td class="table__cell">Машина - 10 тн до 50 м3</td>
  ...
  <tr class="table__row">
    <td class="table__cell">Манипулятор до 5 тн</td>
    <td class="table__cell">5</td>
    <td class="table__cell">от 3 600</td>
  </tr>
  <tr class="table__row">
    <td class="table__cell">Манипулятор до 10 тн</td>
    <td class="table__cell">10</td>
    <td class="table__cell">от 4 200</td>
  </tr>
  <tr class="table__row">
    <td class="table__cell">Манипулятор до 15 тн</td>
