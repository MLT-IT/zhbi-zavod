...
<div data-key="{$productKey}" class="pop-slide swiper-slide product-item listing__products-item" data-views="{$_pls['HitsPage']}" {*itemscope="" itemtype="https://schema.org/Product"*}>
