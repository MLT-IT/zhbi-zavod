    ...
    <div class="product-card__info" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
        ...
        <div class="product-card__info-inner">
            ...
            <div class="product-card__right-info">
                ...
                <span class="product-item__btn product-card__btn-compare product-item__btn-compare{if $checkItems['comp'][$_modx->resource['id']] === 1} active{/if}" href="#">
                ...
                <span class="product-item__btn product-card__btn-fav product-item__btn-fav{if $checkItems['fav'][$_modx->resource['id']] === 1} active{/if}" href="#">
