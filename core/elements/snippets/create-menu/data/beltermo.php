...
function getMenuData() {
    ...
    $data = [
        ...
        $protection => [
            ...
            'column2' => [
                [
                    'uri' => '/protection/20-mm/',
                    'name' => '20 мм',
                    'popular'=>1,
                ],
                [
                    'uri' => '/protection/25-mm/',
                    'name' => '25 мм',
                    'popular'=>1,
                ],
                [
                    'uri' => '/protection/35-mm/',
                    'name' => '35 мм',
                    'popular'=>1,
                ],
            ...
            'column3' => [
                [
                    'uri' => '/protection/pryamaya/',
                    'name' => 'Прямая',
                    'popular'=>1,
                ],
                [
                    'uri' => '/protection/ship-paz/',
                    'name' => 'Шип-паз',
                    'popular'=>1,
                ],
        ...
        $universal => [
            ...
            'column3' => [
                [
                    'uri' => '/universal/pryamaya/',
                    'name' => 'Прямая',
                    'popular'=>1,
                ],
               
                [
                    'uri' => '/universal/ship-paz/',
                    'name' => 'Шип-паз',
                    'popular'=>1,
                ],
