...
class getPopularProductsClass {
    ...
    protected static $group2Parents = [
    ...
    protected static $group3Parents = [
        // Металлочерепица и потомки
        16788,
        11760, 12069, 12070, 12071, 12073, 12074, 16789, 37621, 44676, 44677, 44678, 44679, 44680, 44681, 76923,
    ...
    static protected function krovlya() {
        ...
        switch (true) {
            ...
            // Группа 2
            // -------------------------------
            case in_array(self::$prod->parent, self::$group2Parents):
                $group = 2;
                break;
            ...
            // Группа 3
            // -------------------------------
            case in_array(self::$prod->parent, self::$group3Parents):
                $group = 3;
                break;
        }
...
if (!$result = $modx->cacheManager->get($cacheName, $cacheOptions)) {
    ...
    $result = $modx->runSnippet('msProductsMy', $data['params']);
