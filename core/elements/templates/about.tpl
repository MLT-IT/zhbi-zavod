...
{block "page"}
    ...
    {elseif $_modx->resource.context_key == 'krovlya'}
        {set $textBestPrice = 'Лучшая цена. Владеем собственным автопарком, поэтому можем гарантировать максимально низкую цену на кровлю.'}
        {set $textDelivery = 'Доставка по звонку. После уточнения наличия Вы можете получить стройматериал уже через 2 часа у Вас на объекте! Или в любой удобный для Вас интервал времени.'}
    {elseif $_modx->resource.context_key == 'pro-fanera'}
        {set $textBestPrice = 'Лучшая цена. Мы являемся официальным дистрибьютором, поэтому можем гарантировать максимально низкую цену на фанеру.'}
        {set $textDelivery = 'Доставка по звонку. После уточнения наличия Вы можете получить фанеру уже через 2 часа у Вас на объекте! Или в любой удобный для Вас интервал времени.'}
    {elseif $_modx->resource.context_key == 'fasady-pro'}
        {set $textBestPrice = 'Лучшая цена. Мы являемся официальным дистрибьютором, поэтому можем гарантировать максимально низкую цену на фасадные материалы.'}
        {set $textDelivery = 'Доставка по звонку. После уточнения наличия Вы можете получить фасадные материалы уже через 2 часа у Вас на объекте! Или в любой удобный для Вас интервал времени.'}
    {elseif $_modx->resource.context_key == 'fasad'}
        {set $textBestPrice = 'Лучшая цена. Мы являемся официальным дистрибьютором, поэтому можем гарантировать максимально низкую цену на фасадные материалы.'}
        {set $textDelivery = 'Доставка по звонку. После уточнения наличия Вы можете получить фасадные материалы уже через 2 часа у Вас на объекте! Или в любой удобный для Вас интервал времени.'}
    {elseif $_modx->resource.context_key == 'pilomat'}
        {set $textBestPrice = 'Лучшая цена. Мы являемся официальным дистрибьютором, поэтому можем гарантировать максимально низкую цену на пиломат.'}
        {set $textDelivery = 'Доставка по звонку. После уточнения наличия Вы можете получить пиломатериал уже через 2 часа у Вас на объекте! Или в любой удобный для Вас интервал времени.'}
    {elseif $_modx->resource.context_key == 'plitaosb'}
        {set $textBestPrice = 'Лучшая цена. Мы являемся официальным дистрибьютором, поэтому можем гарантировать максимально низкую цену на плитные материалы.'}
        {set $textDelivery = 'Доставка по звонку. После уточнения наличия Вы можете получить плитный материал уже через 2 часа у Вас на объекте! Или в любой удобный для Вас интервал времени.'}
    {elseif $_modx->resource.context_key == 'plity-mdvp'}
        {set $textBestPrice = 'Лучшая цена. Мы являемся официальным дистрибьютором, поэтому можем гарантировать максимально низкую цену на МДВП плиты.'}
        {set $textDelivery = 'Доставка по звонку. После уточнения наличия Вы можете получить плиту МДВП уже через 2 часа у Вас на объекте! Или в любой удобный для Вас интервал времени.'}
    {elseif $_modx->resource.context_key == 'kirpich-m'}
        {set $textBestPrice = 'Лучшая цена. Мы являемся официальным дистрибьютором, поэтому можем гарантировать максимально низкую цену на кирпич.'}
        {set $textDelivery = 'Доставка по звонку. После уточнения наличия Вы можете получить кирпич уже через 2 часа у Вас на объекте! Или в любой удобный для Вас интервал времени.'}
    {elseif $_modx->resource.context_key == 'armatura-178'}
        {set $textBestPrice = 'Лучшая цена. Мы являемся официальным дистрибьютором, поэтому можем гарантировать максимально низкую цену на арматуру и металлопрокат.'}
        {set $textDelivery = 'Доставка по звонку. После уточнения наличия Вы можете получить арматуру уже через 2 часа у Вас на объекте! Или в любой удобный для Вас интервал времени.'}
    {elseif $_modx->resource.context_key == 'asconcrete'}
        {set $textBestPrice = 'Лучшая цена. Мы являемся официальным дистрибьютором, поэтому можем гарантировать максимально низкую цену на асфальтобетон.'}
        {set $textDelivery = 'Доставка по звонку. После уточнения наличия Вы можете получить асфальт уже через 2 часа у Вас на объекте! Или в любой удобный для Вас интервал времени.'}
    {/if}
    {* <<< Значения для пунктов *}
