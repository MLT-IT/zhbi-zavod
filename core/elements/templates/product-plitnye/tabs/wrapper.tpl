  <article class="product__infoblocks infoblocks infoblocks_style_shadow section">
    <div class="infoblocks__container" data-tabs data-tabs-hiddable="479">
      ...
      <div class="infoblocks__content">
        {include "file:templates/product-plitnye/tabs/description.tpl"}
        {include "file:templates/product-plitnye/tabs/characteristics.tpl"}
        {include "file:templates/product-plitnye/tabs/calculator.tpl"}
        {include "file:templates/product-plitnye/tabs/delivery.tpl"}
        {include "file:templates/product-plitnye/tabs/reviews.tpl"}

        {if $renderCerts ?}
          {include "file:templates/product-plitnye/tabs/certs.tpl"}
        {/if}

        {if $renderVideo == 1}
          {include "file:templates/product-plitnye/tabs/video.tpl"}
        {/if}
