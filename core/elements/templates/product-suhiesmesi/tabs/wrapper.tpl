  <article class="product__infoblocks infoblocks infoblocks_style_shadow section">
    <div class="infoblocks__container" data-tabs data-tabs-hiddable="479">
      ...
      <div class="infoblocks__content">
        {include "file:templates/product-suhiesmesi/tabs/description.tpl"}
        {include "file:templates/product-suhiesmesi/tabs/characteristics.tpl"}
        {include "file:templates/product-suhiesmesi/tabs/delivery.tpl"}
        {include "file:templates/product-suhiesmesi/tabs/reviews.tpl"}

        {if $renderCerts ?}
          {include "file:templates/product-suhiesmesi/tabs/certs.tpl"}
        {/if}

        {if $renderVideo == 1}
          {include "file:templates/product-suhiesmesi/tabs/video.tpl"}
        {/if}

          {if $_modx->resource.recommendForUse != "" && $_modx->context.key in list ['suhiesmesi', 'kraska']}
              {include "file:templates/product-suhiesmesi/tabs/recommend-use.tpl"}
         {/if}
