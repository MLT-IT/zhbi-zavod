...
{block "page"}
    ...
    <div class="wrapper product-card {if $_modx->resource.template == 17}product-card_type_relinking{else}product-card_type_usual{/if}" data-views="{'!HitsPage' | snippet : ['saveTv' => 'true']}" itemscope itemtype="http://schema.org/Product">
