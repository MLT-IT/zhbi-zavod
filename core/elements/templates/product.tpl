...
{block "page"}
    ...
    <div class="wrapper product-card {$cardClass}{if $_modx->resource.old_price?} js-product_with-discount{/if}" data-views="{'!HitsPage' | snippet : ['saveTv' => 'true']}" itemscope itemtype="http://schema.org/Product">
