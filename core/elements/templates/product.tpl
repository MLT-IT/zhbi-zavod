...
{block "page"}
    ...
    <div class="wrapper product-card {$cardClass}{if $outputOldPrice?} product-card_with-discount{/if}" data-views="{'!HitsPage' | snippet : ['saveTv' => 'true']}" itemscope itemtype="http://schema.org/Product">
